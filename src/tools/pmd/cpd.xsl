...
<body>
    ...
    <table border="1" class="summary" cellpadding="2">
      ...
      <tr>
        <td class="SummaryNumber"><xsl:value-of select="count(//duplication[@lines>5])"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>5]/@lines)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>5]/@tokens)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>5]/@tokens) * 4"/></td>
      </tr>
    </table>
    <p/>
